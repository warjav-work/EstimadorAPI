...
/// <summary>
/// Handler para obtener actores de un UseCase
/// </summary>
public class GetUseCaseActorsQueryHandler : IRequestHandler<GetUseCaseActorsQuery, IEnumerable<ActorDto>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;

    public GetUseCaseActorsQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
    {
        _unitOfWork = unitOfWork;
        _mapper = mapper;
    }

    public async Task<IEnumerable<ActorDto>> Handle(GetUseCaseActorsQuery request, CancellationToken cancellationToken)
    {
